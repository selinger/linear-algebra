...
\ifthenelse{\equal{\detokenize{print-cover}}{\jobname}}{
  \begin{tikzpicture}[remember picture,overlay]
    ...
    ([yshift=-0.25in-\bleed-1in,xshift=\bleed+0.5\trimwidth]current page.north west) {
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    ([yshift=-0.25in-\bleed-0.5\trimheight,xshift=\bleed+\trimwidth+0.5\spinewidth]current page.north west) {
      \rotatebox{-90}{%
