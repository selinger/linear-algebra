  ...
  \backgroundsetup{
    ...
    contents={%
      \raisebox{-0.25in}[\height][0in]{%
        \includegraphics[height=\paperheight,width=8.5in+\bleed+\spinewidth]{figures/titlepage-image-print2}%
        \includegraphics[height=\paperheight,width=8.5in+\bleed]{figures/titlepage-image}%
      }%
    }%
  }
}{
...
\ifthenelse{\equal{\detokenize{print-cover}}{\jobname}}{
  \begin{tikzpicture}[remember picture,overlay]
    ...
    ([yshift=-0.25in-\bleed-1.5in,xshift=\bleed+4.25in]current page.north west) {
      \begin{minipage}{5in}
