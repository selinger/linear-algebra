...
% B+W Interior
\setlength{\hectopagethickness}{13.55bp}  % per 100 pages, for accuracy
\setlength{\coverthickness}{0.195bp}

% Color interior
% \setlength{\hectopagethickness}{13.65bp}  % per 100 pages, for accuracy
...
\setlength{\spinewidth}{\hectopagethickness*\numpages/100 + \coverthickness}
