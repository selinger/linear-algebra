...
% B+W Interior
\setlength{\pagethickness}{0.135848bp}

% Color interior
% \setlength{\pagethickness}{0.13688bp}
...
%
% Spine width: B+W interior: 560 * 0.135848bp = 76.075bp
%              Color interior: 560 * 0.13688bp = 76.653bp
% 
...
\setlength{\trim}{0.125in}
\setlength{\spinewidth}{76.075bp} % \numpages * \pagethickness
\setlength{\coverwidth}{\trim + 8.5in + \spinewidth + 8.5in + \trim}
\setlength{\coverheight}{\trim + 11in + \trim}
\setlength{\frontsideleft}{\trim + 8.5in + \spinewidth}

% Options showframe, showcrop, and verbose can be used for debugging
\ifthenelse{\equal{\detokenize{print-cover}}{\jobname}}{
  \geometry{papersize={\coverwidth,\coverheight},layoutsize={8.5in,11in},layoutoffset={\frontsideleft,\trim}}
}{
