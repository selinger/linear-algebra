...
\setlength{\spinewidth}{76.075bp} %  \numpages * 0.13585bp for b/w?
\setlength{\coverwidth}{\trim + 8.5in + \spinewidth + 8.5in + \trim}
\setlength{\coverheight}{\trim + 11in + \trim}
\setlength{\frontsideleft}{\trim + 8.5in + \spinewidth} %Spine begins + Spine width +safe zone

% Options showframe, showcrop, and verbose can be used for debugging
\ifthenelse{\equal{\detokenize{print-cover}}{\jobname}}{
  \geometry{papersize={\coverwidth,\coverheight},layoutsize={8.5in,11in},layoutoffset={\frontsideleft,\trim},body={18.4cm,24.7cm},showframe,showcrop,verbose}
}{
