...
\begin{ex} Let 
\begin{equation*}
V=\mbox{span}\left\{ \begin{mymatrix}{c}
1 \\ 
1 \\ 
2 \\ 
0
...
\begin{ex} Now let $V$ equal $\func{span}\left\{ \begin{mymatrix}{c}
1 \\ 
0 \\ 
1
\end{mymatrix} ,\begin{mymatrix}{c}
...
1 \\ 
1
\end{mymatrix} \right\} $ and let $T:V\rightarrow W$ be a linear transformation
where 
\begin{equation*}
