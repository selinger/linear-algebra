...
\begin{ex} \label{exercomplex1}De Moivre's theorem says $\left[ r\tup{\cos
t+i\sin t} \right] ^{n}=r^{n}\tup{\cos nt+i\sin nt} $ for $n$
...
Then $-n>0$ and so
\[
\left[ r\tup{\cos t+i\sin t} \right] ^{n}=\frac{1}{\left[ r\tup{
\cos t+i\sin t} \right] ^{-n}}=\frac{1}{r^{-n}\tup{\cos \tup{
-nt} +i\sin \tup{-nt} } }
\]
\begin{eqnarray*}
