...
\begin{ex}
  ...
  \begin{enumerate}
  \item $A$ is a $5\times 6$-matrix, $\func{rank}\tup{A} =4$ and 
    $\func{rank}\mat{A\mid B} =4$. 
    
  \item $A$ is a $3\times 4$-matrix, $\func{rank}\tup{A} =3$ and 
    $\func{rank}\mat{A\mid B} =2$.
    
  \item $A$ is a $4\times 2$-matrix, $\func{rank}\tup{A} =4$ and 
    $\func{rank}\mat{A\mid B} =4$. 
    
  \item $A$ is a $5\times 5$-matrix, $\func{rank}\tup{A} =4$ and 
    $\func{rank}\mat{A\mid B} =5$. 
    
  \item $A$ is a $4\times 2$-matrix, $\func{rank}\tup{A} =2$ and 
    $\func{rank}\mat{A\mid B} =2$.
  \end{enumerate}
