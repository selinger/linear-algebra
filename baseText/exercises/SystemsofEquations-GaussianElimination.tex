...
0 & 0 & 0 & 0
\end{mymatrix} .$ Therefore, the solution is of the form $z=t,y=\frac{3}{4}+t\left(
\frac{1}{4}\right) ,x=\frac{1}{2}-\frac{1}{2}t$ where $t\in \R$.
...
\begin{ex}
  ...
  the coefficient matrix, and $\leftB A|B \rightB$ denotes the
