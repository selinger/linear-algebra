...
\begin{ex}
  Find $\proj_{\vect{v}}\tup{\vect{w}} $ where
...
\begin{ex} Find $\proj_{\vect{v}}\tup{\vect{w}} $ where 
  $\vect{w}=\begin{mymatrix}{r}
    1 \\
    2 \\
    -2
...
\begin{ex}
  Find $\comp_{\vect{v}}\tup{\vect{w}} $ where
  $\vect{w}=\begin{mymatrix}{r}
    1 \\
    1 \\
    2
...
\begin{ex} Find $\comp_{\vect{v}}\tup{\vect{w}} $ where 
  $\vect{w}=\begin{mymatrix}{r}
    1 \\
    -1 \\
    0
...
\begin{ex}
  Does it make sense to speak of $\proj_{\vect{0}}\tup{\vect{w}}$?
  \begin{sol}
    No, it does not. The $0$ vector has no direction. The formula for
    $\proj_{\vect{0}}\tup{\vect{w}}$ doesn't make sense either.
  \end{sol}
\end{ex}
...
\begin{ex}
  ...
  \begin{equation*}
    \tup{\vect{w}-
      \proj_{\vect{v}}(\vect{w})} \dotprod \tup{\vect{w}-
...
\begin{ex}\label{perp-linear}
  ...
  $\vect{w}_{\perp }=\vect{w}-\proj_{\vect{v}}\tup{\vect{w}}$.
  \begin{sol}
    \begin{eqnarray*}
      \vect{w}-\proj_{\vect{v}}\tup{\vect{w}} +\vect{u}- \proj_{\vect{v}}\tup{\vect{u}} 
      &=& \vect{w}+\vect{u}-\tup{\proj_{\vect{v}}\tup{\vect{w}} +\proj_{\vect{v}}\tup{\vect{u}} } \\
      &=&\vect{w}+\vect{u}-\proj_{\vect{v}}\tup{\vect{w}+\vect{u}}.
    \end{eqnarray*}
    This follows because 
    \begin{eqnarray*}
      \proj_{\vect{v}}\tup{\vect{w}} +\proj_{\vect{v}}\tup{
      \vect{u}}
      &=& \frac{\vect{u}\dotprod \vect{v}}{\norm{\vect{v}} ^{2}}\vect{v}+
          \frac{\vect{w}\dotprod \vect{v}}{\norm{\vect{v}} ^{2}}\vect{v} \\
      &=& \frac{\tup{\vect{u}+\vect{w}} \dotprod \vect{v}}{\norm{\vect{v}
          } ^{2}}\vect{v} \\
      &=& \proj_{\vect{v}}\tup{\vect{w}+\vect{u}}.
    \end{eqnarray*}
  \end{sol}
\end{ex}
...
\begin{ex} Show that
  ...
  the given vector.
  \begin{sol}
    $\tup{\vect{v}-\proj_{\vect{u}}\tup{\vect{v}} } \dotprod
    ...
    $\vect{v} = \vect{v} - \proj_{\vect{u}}\tup{\vect{v}} +
    \proj_{\vect{u}}\tup{\vect{v}}$. The first is orthogonal to
