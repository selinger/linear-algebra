...
\cdots ,\vec{u}_k\}$ in $\mathbb{R}^{n}$ is known as the span\index{span}\index{vectors!span} of these
...
\vect{u}_{1},\cdots ,\vect{u}_{k}\right\} $ is a \textbf{basis}\index{basis}\index{vectors!basis}\index{subspace!basis} for
