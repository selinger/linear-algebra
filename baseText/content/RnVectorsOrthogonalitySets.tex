...
The collection of all linear combinations of a set of vectors $\set{\vec{u}_1,
\cdots ,\vec{u}_k}$ in $\R^{n}$ is known as the span\index{span}\index{vector!span} of these
vectors and is written as $\sspan \set{\vec{u}_1, \cdots ,
\vec{u}_k}$. \\ 
We call a collection of the form $\sspan \set{\vec{u}_1, \cdots , \vec{u}_k}$ 
a subspace of $\R^{n}$.
\end{definition}
