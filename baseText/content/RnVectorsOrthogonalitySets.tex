...
\cdots ,\vec{u}_k\}$ in $\R^{n}$ is known as the span\index{span}\index{vectors!span} of these
vectors and is written as $\sspan \{\vec{u}_1, \cdots ,
\vec{u}_k\}$. \\ 
We call a collection of the form $\sspan \{\vec{u}_1, \cdots , \vec{u}_k\}$ 
a subspace of $\R^{n}$.
\end{definition}
...
\textbf{linearly independent}\index{linear independence}\index{vectors!linear independence}
...
$\sspan \{\vect{u}, \vect{v}\}$ is the $XY$-plane. Since $\vect{w}$
...
\vect{u}_{1},\cdots ,\vect{u}_{k}} $ is a \textbf{basis}\index{basis}\index{vectors!basis}\index{subspace!basis} for
...
suppose $\R^n=\sspan\{\vect{x}_1, \vect{x}_2, \ldots, \vect{x}_k\}$.
...
\textbf{orthogonal set}\index{orthogonal}\index{vectors!orthogonal}
...
is said to be an
\textbf{orthonormal}\index{orthonormal}\index{vectors!orthonormal}
set if 
\[
...
\sspan \{\vect{w}_1, \vect{w}_2, \cdots, \vect{w}_k\}$.
\end{theorem}
