...
The collection of all linear combinations of a set of vectors $\set{\vect{u}_1,
\cdots ,\vect{u}_k}$ in $\R^{n}$ is known as the span\index{span}\index{vector!span} of these
vectors and is written as $\sspan \set{\vect{u}_1, \cdots ,
\vect{u}_k}$. \\ 
We call a collection of the form $\sspan \set{\vect{u}_1, \cdots , \vect{u}_k}$ 
a subspace of $\R^{n}$.
\end{definition}
...
\vect{u}_{1},\cdots ,\vect{u}_{k}} $ is a \textbf{basis}\index{basis}\index{vector!basis}\index{subspace!basis} for
...
Let $\set{\vect{u}_1, \vect{u}_2, \cdots, \vect{u}_m}$ be a set of
...
Since the set is orthogonal, we know that $\norm{\vect{w}_i}^2  \neq 0$. It follows that $a_i =0$. Since the $a_i$ was chosen arbitrarily, the set $\set{\vect{w}_1, \vect{w}_2, \cdots, \vect{w}_k}$ is linearly independent. 

Finally since $W = \mbox{span} \set{\vect{w}_1, \vect{w}_2, \cdots,
