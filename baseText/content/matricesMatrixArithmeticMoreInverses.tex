...
Theorem \ref{thm:invertiblerref} corresponds to Algorithm \ref{algo:matrixinversionalgorithm}, which claims that $A^{-1}$ is found by row reducing the augmented matrix $\mat{A|I}$ to the form $\mat{I|A^{-1}}$. This will be a matrix product $E\mat{A|I}$ where $E$ is a product of elementary matrices. By the rules of matrix multiplication, we have that $E\mat{A|I} = \mat{EA|EI} = \mat{EA|E}$.
