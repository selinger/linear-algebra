...
column as $T\tup{\vect{e}_{i}}$. Recall that the set $\set{\vect{e}_1, \vect{e}_2,\ldots, \vect{e}_n }$ is called the standard basis of $\R^n$. Therefore the matrix of $T$ is found by applying $T$ to the standard basis. We state this formally as the
following theorem.
