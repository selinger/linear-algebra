...
except those on the main diagonal\index{matrix!diagonal matrix}\index{matrix!main diagonal}. More precisely, if $d_{ij}$ is the $ij\th$ entry of a diagonal matrix $D$, then
