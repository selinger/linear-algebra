...
\begin{solution}
By Definition \ref{def:lineartransformation} we need to show that $T\tup{k \vect{x}_1 + p \vect{x}_2 } = kT\tup{\vect{x}_1}+ pT\tup{\vect{x}_{2} }$ for all scalars $k,p$ and vectors $\vect{x}_1, \vect{x}_2$.
Let
\[
