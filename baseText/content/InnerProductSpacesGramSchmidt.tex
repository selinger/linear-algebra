...
\begin{center}
  \begin{tikzpicture}[domain=1:-1, scale=4]
    \draw[thick,color=yellow] plot (\x,{abs(\x^6)-15/11*abs(\x^4)+5/11*abs(\x^2)-5/231}) node[left=2ex] {$x^6 - \frac{15}{11}x^4 + \frac{5}{11}x^2 - \frac{5}{231}$};
    \draw[thick,color=blue!30!white] plot (\x,{\x^5 - 10/9*\x^3+5/21*\x}) node[left=2ex] {$x^5 - \frac{10}{9}x^3 + \frac{5}{21}x$};
    ...
    \draw[thick,color=blue] plot (\x,{abs(\x^2)-1/3}) node[left=2ex] {$x^2-\frac{1}{3}$};
    \draw[thick,color=red] plot (\x,\x) node[left=2ex] {$x$};
