...
\index{projection!in inner product space} in
Section~\ref{ssec:projections}, except that we have generalized this
concept from $\R^n$ to an arbitrary inner product space. We can define
\begin{equation*}
  \proj_{\vect{w}}(\vect{v})
  = \frac{\iprod{\vect{w},\vect{v}}}{\iprod{\vect{w},\vect{w}}}\vect{w}.
\end{equation*}
