...
\begin{center}
  \begin{tikzpicture}[domain=1:-1, scale=4]
    \definecolor{bleu}{rgb}{0,0.87,1.00}
    \definecolor{pinque}{rgb}{0.97,0.23,0.81}
    \definecolor{jello}{rgb}{1.00,0.87,0.00}
    \definecolor{pineapple}{rgb}{1.00,0.73,0.00}
    \draw[thick,color=jello] plot (\x,{abs(\x^6)-15/11*abs(\x^4)+5/11*abs(\x^2)-5/231}) node[left=2ex] {$x^6 - \frac{15}{11}x^4 + \frac{5}{11}x^2 - \frac{5}{231}$};
    \draw[thick,color=bleu] plot (\x,{\x^5 - 10/9*\x^3+5/21*\x}) node[left=2ex] {$x^5 - \frac{10}{9}x^3 + \frac{5}{21}x$};
