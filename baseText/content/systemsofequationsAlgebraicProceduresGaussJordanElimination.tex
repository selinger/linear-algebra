...
\begin{solution}
  ...
  \begin{equation*}
    \begin{mymatrix}{rrr|r}
      ...
      0 & 0 & \circled{1} & 3
    \end{mymatrix}
    \stackrel{R_2\rowop R_2-R_3}{\stackrel{R_1\rowop R_1-3R_3}{\sim}}
    \begin{mymatrix}{rrr|r}
      \circled{1} & 4 & 0 & 2 \\
      0 & \circled{2} & 0 & 2 \\
      0 & 0 & \circled{1} & 3
    ...
    \begin{mymatrix}{rrr|r}
      ...
      0 & 0 & \circled{1} & 3
    \end{mymatrix}
    \stackrel{R_2\rowop \frac{1}{2}R_2}{\sim}
    \begin{mymatrix}{rrr|r}
      \circled{1} & 0 & 0 & -2 \\
      0 & \circled{1} & 0 & 1 \\
      0 & 0 & \circled{1} & 3
...
\begin{solution}
  ...
  \begin{equation*}
    ...
    \stackrel{R_3\rowop R_3-3R_1}{\sim}}
    \begin{mymatrix}{rrr|rr}
      1 & 0 & 1 & 1 & 2 \\
      0 & 1 & 1 & 0 & 1 \\
      0 & 2 & 2 & 1 & 2 \\
