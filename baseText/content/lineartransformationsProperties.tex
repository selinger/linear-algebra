...
\begin{example}{Linear combination}{linear-transformation-combination}
...
\begin{solution}
  ...
  \index{sum!of two angles}%
  \index{addition!of two angles}, which we have here derived using
