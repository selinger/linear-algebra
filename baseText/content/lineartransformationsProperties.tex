...
Let $T: \R^k \to \R^n$ and $S: \R^n \to \R^m$ be linear transformations. Then the \textbf{composite}\index{linear transformation!composite}\index{composite} of $S$ and $T$ is 
\[
S \circ T: \R^k \to \R^m
\]
