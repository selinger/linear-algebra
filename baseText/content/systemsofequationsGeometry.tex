...
the two equations, or the $(x,y)$ which satisfy both equations. In this case,
there is one point of intersection at $(-1, 4)$ which means we have one unique solution, $x = -1$, $y = 4$.
