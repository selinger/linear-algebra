...
Let us use linear algebra, and in particular principal component
...
centroid of the points, and then we compute a certain $99\times
200$-matrix $A$ and a positive semidefinite $200\times 200$-matrix
$B=A^TA$. Using software, we can find the eigenvalues and -vectors of
$B$. The first few eigenvalues (in decreasing order) are:
\begin{equation*}
...
If we repeat the same calculation for the 2017 senate, we get the
following picture:
\def\senatorsB{
