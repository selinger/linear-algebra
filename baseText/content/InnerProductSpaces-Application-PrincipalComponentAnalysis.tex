...
picture:
\begin{equation*}
  \def\dataD#1#2#3#4#5#6#7{\fill[demo](#5,0) circle (0.09);}
  \def\dataR#1#2#3#4#5#6#7{\fill[repu](#5,0) circle (0.09);}
  \def\dataDx#1#2#3#4#5#6#7{\fill[demo](#5,0) circle (0.09);
    \draw[demo,->,shorten >=0.15cm](#5,0) +(#7,1) node[above] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataRx#1#2#3#4#5#6#7{\fill[repu](#5,0) circle (0.09);
    \draw[repu,->,shorten >=0.15cm](#5,0) +(#7,1) node[above] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataDy#1#2#3#4#5#6#7{\fill[demo](#5,0) circle (0.09);
    \draw[demo,->,shorten >=0.15cm](#5,0) +(#7,-1) node[below] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataRy#1#2#3#4#5#6#7{\fill[repu](#5,0) circle (0.09);
    \draw[repu,->,shorten >=0.15cm](#5,0) +(#7,-1) node[below] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
...
picture:
\begin{equation*}
  \def\dataD#1#2#3#4#5#6#7{\fill[demo](#5,0) circle (0.104);}
  \def\dataR#1#2#3#4#5#6#7{\fill[repu](#5,0) circle (0.104);}
  \def\dataDx#1#2#3#4#5#6#7{\fill[demo](#5,0) circle (0.104);
    \draw[demo,->,shorten >=0.15cm](#5,0) +(#7,1) node[above] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataRx#1#2#3#4#5#6#7{\fill[repu](#5,0) circle (0.104);
    \draw[repu,->,shorten >=0.15cm](#5,0) +(#7,1) node[above] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataDy#1#2#3#4#5#6#7{\fill[demo](#5,0) circle (0.104);
    \draw[demo,->,shorten >=0.15cm](#5,0) +(#7,-1) node[below] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataRy#1#2#3#4#5#6#7{\fill[repu](#5,0) circle (0.104);
    \draw[repu,->,shorten >=0.15cm](#5,0) +(#7,-1) node[below] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
...
\begin{equation*}
  \def\dataD#1#2#3#4#5#6#7{\fill[demo](#5,#6) circle (0.09);}
  \def\dataR#1#2#3#4#5#6#7{\fill[repu](#5,#6) circle (0.09);}
  \def\dataDx#1#2#3#4#5#6#7{\fill[demo](#5,#6) circle (0.09);
    \draw[demo,->,shorten >=0.15cm](#5,#6) +(#7,1) node[above] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataRx#1#2#3#4#5#6#7{\fill[repu](#5,#6) circle (0.09);
    \draw[repu,->,shorten >=0.15cm](#5,#6) +(#7,1) node[above] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataDy#1#2#3#4#5#6#7{\fill[demo](#5,#6) circle (0.09);
    \draw[demo,->,shorten >=0.15cm](#5,#6) +(#7,-1) node[below] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
  \def\dataRy#1#2#3#4#5#6#7{\fill[repu](#5,#6) circle (0.09);
    \draw[repu,->,shorten >=0.15cm](#5,#6) +(#7,-1) node[below] {\rotatebox{90}{\footnotesize #1, #4}} -- +(0,0);}
