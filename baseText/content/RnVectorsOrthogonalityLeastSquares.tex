...
$\func{im}\left( A\right) = = \set{A\vect{x} : \vect{x} \in
\R^n }$. Rephrasing Theorem \ref{thm:orthproj} using
...
\begin{equation*}
\set{\left( x_{1},y_{1}\right),  \left( x_{2},y_{2}\right), \cdots,  \left( x_{n},y_{n}\right)   }
\end{equation*}
...
and $b$ to make 
\begin{equation*}
\left\vectlength A\begin{mymatrix}{c}
m \\ 
b
\end{mymatrix} -\begin{mymatrix}{c}
y_{1} \\ 
\vdots \\ 
y_{n}
\end{mymatrix} \right\vectlength ^{2}
\end{equation*}
