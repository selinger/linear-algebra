...
$\func{im}\tup{A} = \set{A\vect{x} \mid \vect{x} \in
...
\proj_{W}\tup{\vect{y}}$, and let $\vect{x} \in \R^{n}$ such that $\vect{z}=A\vect{x}$.
...
\begin{equation*}
\set{\tup{x_{1},y_{1}},  \tup{x_{2},y_{2}},\ldots,  \tup{x_{n},y_{n}}   }
\end{equation*}
