...
\textbf{Elementary operations}\index{elementary operation} are the
...
\item To prove that the systems \eqref{system} and \eqref{thm-1.9.2}
  have the same solution set, let $\tup{x_{1},\ldots,x_{n}}$ be
  ...
  $\tup{x_{1},\ldots,x_{n}}$ is a solution of
  \eqref{thm-1.9.2}. Conversely, let $\tup{x_{1},\ldots,x_{n}}$
  ...
  $\tup{x_{1},\ldots,x_{n}}$ is also a solution of
...
\begin{solution}
  ...
  \begin{equation*}
    ...
    \end{array}
  \end{equation*}
  which is the same as {\eqref{solving-a-system3}}. We solve it by back
