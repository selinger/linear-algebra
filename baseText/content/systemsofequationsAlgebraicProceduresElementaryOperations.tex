...
\begin{definition}{Equivalent Systems}{equivalentsystems}
  ...
  \textbf{equivalent}\index{system of linear equations!equivalent}
...
\index{augmented matrix}\index{matrix!augmented} notation. Recall the
...
\textbf{coefficient matrix}\index{coefficient
  matrix}\index{matrix!coefficient matrix} and the \textbf{constant
...
\begin{definition}{Augmented Matrix of a System of Linear Equations}{augmentedmatrix}
  The \textbf{augmented matrix}
  \index{augmented matrix}\index{matrix!augmented matrix}
...
\begin{definition}{Elementary Row Operations}{rowoperations}
  ...
  \index{row operations} \index{elementary row operations}
