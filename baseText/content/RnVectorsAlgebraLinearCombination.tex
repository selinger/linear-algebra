...
\begin{outcome}
\begin{enumerate}
\item[A.] Compute linear combinations of vectors algebraically and
  geometrically.
\item[B.] Determine whether a vector is a linear combination of given
  vectors.
\item[C.] Find the coefficients of one vector as a linear combination
  of other vectors.
\end{enumerate}
\end{outcome}
