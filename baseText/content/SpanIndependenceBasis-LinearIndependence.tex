...
\begin{solution}
  ...
  \item The vector $\vect{u}_4$ is redundant, because $\vect{u}_4 =
    \vect{u}_2 + \vect{u}_3$.
  \item The vector $\vect{u}_5$ is not redundant, because it cannot be
    written as a linear combination of $\vect{u}_1$, $\vect{u}_2$,
    $\vect{u}_3$, and $\vect{u}_4$.  This is because the system of
    equations\vspace{-0.25ex}
    \begin{equation*}
...
\begin{example}{Characterization of linear independence}{characterization-linear-independence}
  ...
  \begin{equation*}
    ...
    \vect{u}_4 = \begin{mymatrix}{r} 2 \\ 3 \\ 7 \\ 1 \end{mymatrix}.
  \end{equation*}
\end{example}
...
\begin{solution}
  ...
  \begin{equation*}
    ...
    + a_4 \begin{mymatrix}{r} 2 \\ 3 \\ 7 \\ 1 \end{mymatrix}
