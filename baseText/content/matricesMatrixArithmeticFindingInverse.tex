In Example \ref{exa:verifying-inverse}, we were verified that a matrix
...
% ======================================================================
% CONTINUE HERE: Note: the method for solving multiple systems in one
% go was already discussed in Chapter 1.
