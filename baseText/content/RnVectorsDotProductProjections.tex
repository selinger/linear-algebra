...
\begin{example}{Find the projection of one vector onto another}{vector-projection}
  Find $\proj_{\vect{u}}\tup{\vect{v}}$ if
  \begin{equation*}
    \vect{u}=
    \begin{mymatrix}{r}
      2 \\
...
\begin{solution}
  ...
  to find $\proj_{\vect{u}}\tup{\vect{v}}$.  First, compute
...
\begin{proof}
  ...
  \begin{equation*}
    \vect{v}_{\coll} = \proj_{\vect{u}}\tup{\vect{v}} = \frac{\vect{v}\dotprod \vect{u}}{\vect{u}\dotprod \vect{u}}\, \vect{u},
  \end{equation*}
