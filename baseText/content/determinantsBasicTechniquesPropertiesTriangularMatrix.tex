...
Let $A$ be an upper or lower triangular matrix. Then $\det (A) $
...
the main diagonal. Thus $\det (A) =1\times 2\times 3\times (
-1) =-6$. 
...
0 & 3 & 33.7 \\
0 & 0 & -1
\end{absmatrix} +0(-1) ^{2+1}\begin{absmatrix}{rrr}
2 & 3 & 77 \\
0 & 3 & 33.7 \\
0 & 0 & -1
\end{absmatrix} + \\
&&0(-1) ^{3+1}\begin{absmatrix}{rrr}
2 & 3 & 77 \\
2 & 6 & 7 \\
0 & 0 & -1
\end{absmatrix} +0(-1) ^{4+1}\begin{absmatrix}{rrr}
2 & 3 & 77 \\
2 & 6 & 7 \\
0 & 3 & 33.7
\end{absmatrix}
...
3 & 33.7 \\
0 & -1
\end{absmatrix} +0(-1) ^{2+1}\begin{absmatrix}{rr}
6 & 7 \\
0 & -1
\end{absmatrix} +0(-1) ^{3+1}\begin{absmatrix}{rr}
6 & 7 \\
3 & 33.7
\end{absmatrix})
\end{equation*}
