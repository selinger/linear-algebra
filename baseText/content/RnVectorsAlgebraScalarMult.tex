...
\begin{theorem}{Properties of scalar multiplication}{vector-scalar-mult}
  The following properties hold for vectors
  $\vect{u},\vect{v}\in\R^{n}$ and $k,p$ scalars.%
  \index{vector!properties of scalar multiplication}%
  \index{properties of scalar multiplication!vectors}%
  \begin{itemize}
