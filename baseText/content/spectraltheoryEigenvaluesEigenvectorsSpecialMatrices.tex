...
matrix. In \ref{elementary-eigenvalue} multiplication by the elementary matrix on
...
matrices, the transition to the new matrix in \ref{elementary-eigenvalue} can be
illustrated by
\begin{equation*}
\begin{mymatrix}{rrr}
33 & -105 & 105 \\
