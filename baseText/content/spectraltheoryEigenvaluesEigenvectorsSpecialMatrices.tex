\section{Eigenvalues and eigenvectors for special types of matrices}
...
Note that this proof also demonstrates that the eigenvectors of $A$ and $B$ will (generally) be {\em different}.
