...
\definecolor{my-blue}{rgb}{0,0.8,1}
\definecolor{my-darkblue}{rgb}{0,0.3,1}
\definecolor{my-red}{rgb}{1,0,0}
...
\begin{solution}
  ...
  \begin{center}
    \begin{tikzpicture}[domain=-1:1, scale=3, samples=25]
      ...
      \draw[thick,color=my-blue] plot (\x,{0.5*\fA{\x} - 0.9375*\fC{\x}});
      \path[color=my-blue] (0.6,0.6) node[right]{$g(x)= \frac{13}{16} - \frac{15}{16}x^2$};
...
\begin{solution}
  ...
  \begin{center}
    \begin{tikzpicture}[domain=-1:1, scale=4, samples=25]
      ...
      \draw[thick,color=my-blue] plot (\x,{0.5*\fA{\x} - 0.9375*\fC{\x}}) (1,-0.18) node[right=1ex] {$f_2$};
      \draw[thick,color=my-green,samples=50] plot (\x,{0.5*\fA{\x} - 0.9375*\fC{\x} + 0.8203125*\fE{\x}}) (1,0.18) node[right=1ex] {$f_4$};
      \draw[thick,color=my-darkblue,samples=50] plot (\x,{0.5*\fA{\x} - 0.9375*\fC{\x} + 0.8203125*\fE{\x} -1.46630859375*\fG{\x}}) (1,-0.06) node[right=1ex] {$f_6$};
      \draw[thick,color=my-red,samples=75] plot (\x,{0.5*\fA{\x} - 0.9375*\fC{\x} + 0.8203125*\fE{\x} -1.46630859375*\fG{\x}+3.338470458984375*\fI{\x}}) (1,0.06) node[right=1ex] {$f_8$};
      \draw[->] (-1.5,0) -- (1.5,0) node[right] {$x$};
      \draw[->] (0,-0.3) -- (0,1.1) node[above] {$p(x)$};
      \draw (1,0) -- (1,-0.05) node[below] {$1$};
      \draw (-1,0) -- (-1,-0.05) node[below] {$-1$};
