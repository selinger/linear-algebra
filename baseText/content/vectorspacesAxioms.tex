...
\begin{definition}{Vector space}{vector-space}
  ...
  \index{multiplication!scalar multiplication|see{scalar
...
\index{$K$-vector space} to refer to a vector space over a field $K$.
...
\begin{example}{Vector space of polynomials of degree 2}{vector-space-polynomial2}
  Let $\Poly_2$%
  \index{P2@$\Poly_2$}%
...
\begin{example}{Vector space of matrices}{vector-space-matrices}
  Let $\Mat_{n,m}$%
  \index{Mnm@$\Mat_{n,m}$} be the set of all $n\times m$-matrices
...
\begin{example}{Vector space of functions}{vector-space-function}
  ...
  \index{FuncX@$\Func_X$} to be the set of functions
...
\begin{example}{Vector space of polynomials of unbounded degree}{vector-space-polynomial}
