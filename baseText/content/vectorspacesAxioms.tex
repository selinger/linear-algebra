...
\begin{example}{Vector space of polynomials of degree 2}{vector-space-poly2}
  Let $\Poly_2$%
  \index{P2@$\Poly_2$}%
...
\begin{example}{Vector space of polynomials of unbounded degree}{vector-space-poly}
