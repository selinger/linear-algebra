...
a point $\tup{a, b}$ in the coordinate plane. There is 
...
\begin{equation*}
\tup{\frac{a}{r} } ^{2}+\tup{\frac{b}{r}} ^{2}=   \frac{a^2+b^2}{r^2}=1
\end{equation*}
and so $\tup{\frac{a}{r},\frac{b}{r}}$
...
The polar form of the complex number $z=a+bi = r \tup{\cos \theta +i\sin \theta }$ is for convenience written as:
\begin{equation*}
z = r e^{i \theta}
\end{equation*}
...
Now, to find $\theta$, we plot the point $\tup{2, 2 }$ and
