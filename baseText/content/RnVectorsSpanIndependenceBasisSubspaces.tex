...
\vect{u}_{1},\cdots ,\vect{u}_{k}} $ is a \textbf{basis} for $V$ if the following two conditions hold.\index{basis}\index{vector!basis}
...
since $V=\sspan\set{\vect{u}_1, \vect{u}_2, \vect{u}_3}$ where
