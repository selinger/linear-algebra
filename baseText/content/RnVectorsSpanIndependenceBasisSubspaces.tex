...
This test allows us to determine if a given set is a subspace of $\R^n$. Notice that the subset $V = \left\{ \vect{0} \right\}$ is a subspace of $\R^n$ (called the zero subspace\index{zero subspace}), as is $\R^n$ itself. A subspace which is not the zero subspace of $\R^n$ is referred to as a proper subspace\index{proper subspace}.
...
\begin{mymatrix}{c} 1\\ 0\\ 0\\ 1\end{mymatrix} \right\}\]
...
\[ U=\left\{ \left.\begin{mymatrix}{c} a\\ b\\ c\\ d\end{mymatrix}
...
\begin{mymatrix}{c} 2\\ 3\\ 3\\ 2\end{mymatrix} \right\},\]
...
\vect{w}_{1},\cdots ,\vect{w}_{m}\right\} $ which is a basis for $W$.\index{spanning set!basis}
\end{theorem}
...
\begin{equation*}
\limfunc{span}\left\{ \begin{mymatrix}{r}
1 \\ 
2 \\ 
-1 \\ 
1
