...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw[thick, red](0,1.5)--(1.5,0);
    \draw[thick, blue](0,0)--(1.5,1.5);
    \draw[thick, green!60!black](0.5,0)--(0.5,1.5);
    \node[below right] at (2,0){$x$};
    \node[left] at (0,2){$y$};
    ...
    \draw[thick, green!60!black](5.75,0)--(5.75,1.5);
...
\begin{center}
  \begin{tikzpicture}[scale=0.6,z={(-0.55,-0.45)}]
    \draw[fill=gray!30] (0,0,-4) -- (0,0,2) -- (-3,0,2) -- (-3,0,-4) -- cycle;
    \draw[fill=gray!90] (0,0,-4) -- (1.5,-2,-4) -- (1.5,-2,2) -- (0,0,2) -- cycle;
    \draw[fill=gray!30] (0,0,-4) -- (0,0,2) -- (3,0,2) -- (3,0,-4) -- cycle;
    \draw[fill=gray!90] (0,0,-4) -- (-1.5,2,-4) -- (-1.5,2,2) -- (0,0,2) -- cycle;
  \end{tikzpicture}
\end{center}
...
\begin{center}
  \begin{tikzpicture}[scale=0.6,z={(-0.55,-0.45)}]
    \draw[fill=gray!30] (0,0,-4) -- (0,0,2) -- (-3,0,2) -- (-3,0,-4) -- cycle;
    \draw[fill=red!30] (-0.75,1,-4) -- (-0.75,1,2) -- (-2.5,1,2) -- (-2.5,1,-4) -- cycle;
    \draw[fill=gray!90] (0,0,-4) -- (1.5,-2,-4) -- (1.5,-2,2) -- (0,0,2) -- cycle;
    \draw[fill=gray!30] (0,0,-4) -- (0,0,2) -- (3,0,2) -- (3,0,-4) -- cycle;
    \draw[fill=gray!90] (0,0,-4) -- (-1.5,2,-4) -- (-1.5,2,2) -- (0,0,2) -- cycle;
    \draw[fill=red!30] (0.75,1,-4) -- (0.75,1,2) -- (-0.75,1,2) -- (-0.75,1,-4) -- cycle;
  \end{tikzpicture}
\end{center}
...
\begin{center}
  \begin{tikzpicture}[scale=0.6,z={(-0.55,-0.45)}]
    \draw[fill=gray!30] (0,0,0) -- (0,0,-4) -- (-3,0,-4) -- (-3,0,0) -- cycle;
    \draw[fill=gray!90] (0,0,0) -- (1.5,-2,0) -- (1.5,-2,-4) -- (0,0,-4) -- cycle;
    \draw[fill=gray!30] (0,0,0) -- (0,0,-4) -- (3,0,-4) -- (3,0,0) -- cycle;
    \draw[fill=gray!90] (0,0,0) -- (-1.5,2,0) -- (-1.5,2,-4) -- (0,0,-4) -- cycle;
    \draw[fill=red!30] (-3,0,0) -- (3,0,0) -- (3,-2,0) -- (-3,-2,0) -- cycle;
    \draw[fill=gray!30] (0,0,0) -- (0,0,2) -- (-3,0,2) -- (-3,0,0) -- cycle;
    \draw[fill=gray!90] (0,0,0) -- (1.5,-2,0) -- (1.5,-2,2) -- (0,0,2) -- cycle;
    \draw[fill=gray!30] (0,0,0) -- (0,0,2) -- (3,0,2) -- (3,0,0) -- cycle;
    \draw[fill=red!30] (-3,0,0) -- (3,0,0) -- (3,2,0) -- (-3,2,0) -- cycle;
    \draw[fill=gray!90] (0,0,0) -- (-1.5,2,0) -- (-1.5,2,2) -- (0,0,2) -- cycle;
  \end{tikzpicture}
...
\begin{center}
  \begin{tikzpicture}[scale=0.6,z={(-0.55,-0.45)}]
    \draw[fill=gray!30] (0,0,-4) -- (0,0,2) -- (-3,0,2) -- (-3,0,-4) -- cycle;
    \draw[fill=red!30] (-1.5,-2,-4) -- (-1.5,-2,2) -- (0,0,2) -- (0,0,-4) -- cycle;
    \draw[fill=gray!90] (0,0,-4) -- (1.5,-2,-4) -- (1.5,-2,2) -- (0,0,2) -- cycle;
    \draw[fill=gray!30] (0,0,-4) -- (0,0,2) -- (3,0,2) -- (3,0,-4) -- cycle;
    \draw[fill=gray!90] (0,0,-4) -- (-1.5,2,-4) -- (-1.5,2,2) -- (0,0,2) -- cycle;
    \draw[fill=red!30] (1.5,2,-4) -- (1.5,2,2) -- (0,0,2) -- (0,0,-4) -- cycle;
