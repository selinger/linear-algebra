  ...
  \begin{equation*}
    \begin{tikzpicture}[scale=0.8, color=blue!50!black]
      ...
      \begin{scope}[yshift=-1cm, xshift=0cm, color=black]
        \draw[->] (1.5,0) -- node[above] {$x$-axis} +(3,0);
        \draw (3,0) -- +(0,-0.2) node[below=-4pt] {$x=0$};
      \end{scope}
      \begin{scope}[yshift=-1cm, xshift=4.2cm, color=black]
        \draw[->] (1.5,0) -- node[above] {$y$-axis} +(3,0);
        \draw (3,0) -- +(0,-0.2) node[below=-4pt] {$y=0$};
      \end{scope}
      \begin{scope}[yshift=-1cm, xshift=8.4cm, color=black]
        \draw[->] (1.5,0) -- node[above] {$z$-axis} +(3,0);
