\section{Addition of vectors in \texorpdfstring{$\R^n$}{Rn}}
...
\vdots \\
v_{n}
\end{mymatrix} \in \R^{n}$, the sum\index{vector!addition}
...
\begin{proposition}{Geometry of vector addition}{geometryofvectoraddition}
...
\begin{definition}{Negative}{vector-negative}
  The \textbf{negative}\index{vector!negative} of a vector
...
To define the \textbf{subtraction}\index{vector!subtraction} of two
...
\textbf{zero vector}\index{zero vector}\index{vector!zero}, the vector
