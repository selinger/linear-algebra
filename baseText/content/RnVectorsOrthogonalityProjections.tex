...
=
\tup{\frac{\vect{y} \dotprod \vect{w}_1}{ \vectlength \vect{w}_1 \vectlength^2}} \vect{w}_1
+
\tup{\frac{\vect{y} \dotprod \vect{w}_2}{ \vectlength \vect{w}_2 \vectlength^2}} \vect{w}_2
+
\cdots
+
\tup{\frac{\vect{y} \dotprod \vect{w}_m}{ \vectlength \vect{w}_m \vectlength^2}} \vect{w}_m
\]
...
\]
\begin{eqnarray*}
\vect{w}_2 &=& \vect{u}_2 - \tup{\frac{ \vect{u}_2 \dotprod \vect{w}_1}{\vectlength \vect{w}_1 \vectlength^2} }  \vect{w}_1\\
&=& \begin{mymatrix}{c}
0 \\
1 \\
2
