...
for this application is Kirchhoff's law\index{Kirchhoff's law}.
...
\begin{solution}
  ...
  amps and sum the resulting products. Specifically, consider the
  ...
  (negative) direction. The product of resistance and amps is then
