...
Let $\set{\vect{u}_1,\cdots ,\vect{u}_n} $ be a set of
linearly independent vectors in $\R^{n}$.

\textbf{I:} Construct a new set of vectors $\set{\vect{v}_1,\cdots ,\vect{v}_n} $ as follows:
\[ \begin{array}{ll}
\vect{v}_1 & = \vect{u}_1 \\
...
\item $\sspan\set{\vect{u}_1,\cdots ,\vect{u}_n } = \sspan \set{\vect{v}_1, \cdots, \vect{v}_n } = \sspan\set{\vect{w}_1,\cdots ,\vect{w}_n }$.
\end{enumerate}
\end{algorithm}
...
\vect{u}_1,\cdots ,\vect{u}_n } = \sspan\set{
