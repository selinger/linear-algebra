...
2 \\
3 
\end{mymatrix}$ be the normal vector for a plane which contains the point $P_0 = \left( 2, 1, 4 \right)$. Determine if the point $P = \left( 5, 4, 1 \right)$ is contained in this plane. 
\end{example}
...
b \\
c
\end{mymatrix}$, $P = \left( x,y,z\right)$ and $P_0 = (x_0, y_0, z_0 )$.
