...
\begin{definition}{General equation of a plane}{general-equation-plane}
...
\begin{solution}
  ...
  \]
  and $\norm{\longvect{QP}}$ is the shortest distance from $P$ to the plane. Further, the vector $\vect{q} = \vect{p} - \longvect{QP}$ gives the necessary point $Q$.
  \begin{center}
