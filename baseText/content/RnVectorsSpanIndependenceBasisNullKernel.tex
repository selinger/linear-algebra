...
What about an efficient description of the row space? By Lemma \ref{lem:echelon-form-row-space} we know that the nonzero rows of $R$ create a basis of $\func{row}(A)$.  For the above matrix, the row space equals 
\[
\func{row}(A) = 
\func{span} \set{
\begin{mymatrix}{rrrrr}
