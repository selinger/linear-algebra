...
\begin{equation*}
\func{null} \left( A\right) =\set{\vect{x} :A \vect{x} =\vect{0}}
\end{equation*}
\end{definition}
...
\[
\func{im}\left( A \right) = \set{A\vect{x} : \vect{x} \in \R^n }
\]
\end{definition}
...
Finally $\func{im}\left( A\right) $ is just $\set{A\vect{x} :
...
vectors above. Thus 
\begin{equation*}
\func{null} \left( A\right) =\func{span}\set{\begin{mymatrix}{r}
-\vspace{0.05in}\frac{3}{5} \\ 
-\vspace{0.05in}\frac{1}{5} \\ 
1 \\ 
0 \\ 
...
The dimension of the null space of a matrix is called the \textbf{nullity}\index{nullity}, denoted $\dim( \func{null}\left(A\right))$.
\end{definition}
