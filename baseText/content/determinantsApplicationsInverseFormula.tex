\section{Application: A formula for the inverse}
...
%\begin{equation*}
%\sum_{i=1}^{n}a_{ir}
%\func{cof}(A) _{ir}\det (A)^{-1}=\det (A)\det (A)^{-1}=1
%\end{equation*}
%Consider the following similar expression for $k\neq r$. 
%\begin{equation*}
%\sum_{i=1}^{n}a_{ir}\func{cof}(A) _{ik}\det (A)^{-1}
%\end{equation*}
%
...
%\func{cof}(A) _{ik}\det (A) ^{-1}
%\end{equation*}
%Summarizing,
%\begin{equation*}
%\sum_{i=1}^{n}a_{ir}\func{cof}(A) _{ik}\det (A)
%^{-1}=\delta _{rk} = \left\{
%\begin{array}{c}
%1\text{ if }r=k \\
%0\text{ if }r\neq k
...
%Now notice that 
%\begin{equation*}
%\sum_{i=1}^{n}a_{ir}\func{cof}(A) _{ik}=\sum_{i=1}^{n}a_{ir}
%\func{cof}(A) _{ki}^{T}
%\end{equation*}
%which is the $kr^{th}$ entry of $\func{cof}(A) ^{T}A$. Therefore rewriting the above we obtain:
%\begin{equation}
