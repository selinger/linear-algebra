...
\textbf{similar}\index{similar matrices} if and only if there exists
...
diagonalizable\index{diagonalizable}.  We define a diagonal matrix $D$
as a matrix containing a zero in every entry except those on the main
diagonal\index{matrix!diagonal matrix}\index{matrix!main
...
\begin{definition}{Diagonalizable}{diagonalizable}
  ...
  \textbf{diagonalizable}\index{diagonalizable} if there exists an
...
The most important theorem about diagonalizability is the following
major result.
