...
\begin{theorem}{Linearly independent eigenvectors}{linear-independent-eigenvectors}
...
\begin{solution}
  ...
  $\eigenvar_1 =1, \eigenvar_2=1$.  To find the eigenvectors, we solve the
  equation $(\eigenvar I - A) X = 0$.  The matrix $(\eigenvar I -A)$ is
  given by
  \begin{equation*}
    \begin{mymatrix}{cc}
      \eigenvar - 1 & -1 \\
    ...
    \end{mymatrix}
  \end{equation*}
  Substituting in $\eigenvar = 1$, we have the matrix
  \begin{equation*}
    \begin{mymatrix}{cc}
      1 - 1 & -1 \\
      0 & 1 - 1
    ...
    \end{mymatrix}
  \end{equation*}
  Then, solving the equation $(\eigenvar I - A) X = 0$
...
\begin{definition}{Eigenspace}{eigenspace}
  Let $A$ be an $n\times n$-matrix and $\eigenvar\in\R$.  The eigenspace
  of $A$ corresponding to $\eigenvar$, written $E_{\eigenvar}(A)$ is the
  set of all eigenvectors corresponding to $\eigenvar$.
\end{definition}

In other words, the eigenspace $E_{\eigenvar}(A)$ is all $X$ such that
$AX = \eigenvar X$. Notice that this set can be written
$E_{\eigenvar}(A) = \nullspace(\eigenvar I - A)$, showing that
$E_{\eigenvar}(A)$ is a subspace of $\R^n$.
