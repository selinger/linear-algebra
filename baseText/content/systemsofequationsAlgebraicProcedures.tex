...
\textbf{consistent}\index{consistent system} if there exists at least one solution. It is
called
\textbf{inconsistent}\index{inconsistent system} if there is no solution.
\end{definition}
