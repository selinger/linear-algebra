...
%%\begin{equation*}
%%\vect{x}^{T}\tup{-A} \vect{x}\geq \delta \vectlength \vect{x}\vectlength
%%^{2}.
%%\end{equation*}
...
%%\end{equation*}
%%Now $\vectlength U^{T}\vect{x}\vectlength ^{2}=\tup{U^{T}\vect{x}}
...
\end{equation*}
\begin{equation*}
=\abs{\alpha _{1}}^{2}\lambda _{1}\vectlength \vect{u}
_{1}\vectlength ^{2}+\abs{\alpha _{2}}^{2}\lambda
