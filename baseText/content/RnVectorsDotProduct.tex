...
\begin{equation}
\abs{\vect{u}\dotprod \vect{v}}\leq \vectlength \vect{u}\vectlength \vectlength \vect{v}\vectlength   \label{cauchy}
\end{equation}
...
\end{equation*}
which is equivalent to $\abs{\vect{u}\dotprod \vect{v} }<\vectlength \vect{u}\vectlength \vectlength \vect{v}\vectlength $.
\end{proof}
...
&\leq& \vectlength \vect{u}\vectlength ^{2}+2\abs{\vect{u}\dotprod \vect{v}}+\vectlength \vect{v}\vectlength ^{2} \\
...
^{2}<0<\abs{k} \vectlength \vect{u}\vectlength ^{2}=\abs{\vect{u}\dotprod \vect{v}}
\end{equation*}
Therefore, $k \geq 0.$
