...
\begin{example}{Solving a system of equations: one solution}{system-with-one-soln}
...
\begin{solution} The augmented matrix for this system is
  ...
  \begin{equation*}
    ...
    \begin{mymatrix}{rrr|r}
      ...
      1 & 1 & 2 & 5
    \end{mymatrix}
    \stackrel{R_3\rowop R_3-R_1}{\sim}
    \begin{mymatrix}{rrr|r}
      \circled{1} & 4 & 3 & 11 \\
      0 & 2 & 1 & 5 \\
      0 & -3 & -1 & -6
  ...
  \begin{equation*}
    \begin{mymatrix}{rrr|r}
      ...
      0 & -3 & -1 & -6
    \end{mymatrix}
    \stackrel{R_3\rowop 2R_3}{\sim}
    \begin{mymatrix}{rrr|r}
      \circled{1} & 4 & 3 & 11 \\
      0 & \circled{2} & 1 & 5 \\
      0 & -6 & -2 & -12
    \end{mymatrix}
    \stackrel{R_3\rowop R_3+3R_2}{\sim}
    \begin{mymatrix}{rrr|r}
      \circled{1} & 4 & 3 & 11 \\
      0 & \circled{2} & 1 & 5 \\
      0 & 0 & 1 & 3
  ...
  \begin{equation}\label{eqn:system-with-one-soln-1}
    \begin{mymatrix}{rrr|r}
      \circled{1} & 4 & 3 & 11 \\
      0 & \circled{2} & 1 & 5 \\
      0 & 0 & \circled{1} & 3
  ...
  because by Theorem~\ref{thm:elementary-operations-and-solns}, any
  solution of the original system of equations would also have to be a
  solution of {\eqref{eqn:system-with-one-soln-1}}, and the back
  substitution leaves us no choice except $z=3$, $y=1$, and $x=-2$.
\end{solution}

\begin{example}{Solving a system of equations: no solution}{system-with-no-soln}
  Solve the following system of equations:
  \begin{equation*}
    \begin{array}{r@{~}c@{~}l}
           y  +2z &=& 2\\
...
\begin{example}{Solving a system of equations: an infinite set of solutions}{infinite-set-of-soln}
  Solve the following system of equations:
  \begin{equation}
    \begin{array}{r@{~}c@{~}l}
      3x  -y  +5z &=& 8 \\
...
In Example~\ref{exa:infinite-set-of-soln} the solution involved a
parameter. It may happen that the solution to a system involves more
than one parameter, as shown in the following example.

\begin{example}{Solving a system of equations: a two parameter set of solutions}{two-parameter-set-of-soln}
  Solve the following system of equations:
  \begin{equation*}
    \begin{array}{r@{~}c@{~}l}
      x +2y  -2z  +2w &=& 3 \\
...
In
Examples~\ref{exa:system-with-one-soln}--\ref{exa:two-parameter-set-of-soln},
