...
\end{equation*}
Then the dimensionless variable is $V^{-1}V_0^{1}$. However, it is written
as $V/V_0$. This is called the Mach number $\mathcal{M}$. Finally, let
$x_7=1$ and all the other free variables equal 0. Then
\begin{equation*}
