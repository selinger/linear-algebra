...
\begin{proof}
Let $z=a+bi$ and let $z=\left\vert z\right\vert \tup{\cos
...
\begin{equation*}
w^k = (r e^{i \alpha})^k = r^k e^{ik\alpha} = r^{k}\tup{\cos k\alpha +i\sin k\alpha } =\left\vert z\right\vert
\tup{\cos \theta+i\sin \theta} 
\end{equation*}
This requires $r^{k}=\left\vert z\right\vert $ and so $r=\left\vert
z\right\vert ^{1/k}$. Also, both $\cos \tup{k\alpha } =\cos \theta$ and
...
\begin{equation*}
\left\vert z\right\vert ^{1/k}\tup{\cos \tup{\frac{\theta+2 \ell \pi }{k}}
