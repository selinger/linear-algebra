...
\begin{equation*}
\left| z\right| =\tup{z\overline{z}} ^{1/2}
\end{equation*}
...
Then,
\begin{equation*}
\left\vert z+w\right\vert ^{2}=\tup{a+c+i\tup{b+d} } \tup{
a+c-i\tup{b+d} }
\end{equation*}
\begin{equation*}
=\tup{a+c} ^{2}+\tup{b+d}
...
z\right\vert \left\vert w\right\vert =\tup{\left\vert z\right\vert
