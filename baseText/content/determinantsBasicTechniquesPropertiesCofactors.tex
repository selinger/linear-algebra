...
\det \tup{A} = 
1 \overset{
\func{cof}\tup{A} _{11}}{\overbrace{\tup{-1} ^{1+1}\left|
\begin{array}{rr}
3 & 2 \\
2 & 1
\end{array}
\right| }}+4 \overset{\func{cof}\tup{A} _{21}}{\overbrace{\tup{
-1} ^{2+1}\left|
\begin{array}{rr}
2 & 3 \\
2 & 1
\end{array}
\right| }}+3 \overset{\func{cof}\tup{A} _{31}}{\overbrace{\tup{
-1} ^{3+1}\left|
\begin{array}{rr}
2 & 3 \\
3 & 2
...
2 & 1
\end{array}
\right| }}+3 \overset{\func{cof}\tup{A} _{22}}{\overbrace{\tup{
-1} ^{2+2}\left|
\begin{array}{rr}
1 & 3 \\
3 & 1
\end{array}
\right| }}+2 \overset{\func{cof}\tup{A} _{23}}{\overbrace{\tup{
-1} ^{2+3}\left|
\begin{array}{rr}
1 & 2 \\
3 & 2
...
\det \tup{A} 
=
3\tup{-1} ^{1+3}\left\vert
\begin{array}{rrr}
5 & 4 & 3 \\
1 & 3 & 5 \\
3 & 4 & 2
\end{array}
\right\vert +2\tup{-1} ^{2+3}\left\vert
\begin{array}{rrr}
1 & 2 & 4 \\
1 & 3 & 5 \\
3 & 4 & 2
...
\end{equation*}
\begin{equation*}
4\tup{-1} ^{3+3}\left\vert
\begin{array}{rrr}
1 & 2 & 4 \\
5 & 4 & 3 \\
3 & 4 & 2
\end{array}
\right\vert +3\tup{-1} ^{4+3}\left\vert
\begin{array}{rrr}
1 & 2 & 4 \\
5 & 4 & 3 \\
1 & 3 & 5
